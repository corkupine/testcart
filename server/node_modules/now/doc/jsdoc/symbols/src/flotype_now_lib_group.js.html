...
<span class='line'> 22</span> <span class='line'> 23</span> 
</span><span class="WHIT">    </span><span class="NAME">this.groupName</span><span class="WHIT"> </span><span class="PUNC">=</span><span class="WHIT"> </span><span class="NAME">groupName</span><span class="PUNC">;</span><span class="WHIT">
...
<span class='line'>150</span> <span class='line'>151</span>          * @name Group#join
<span class='line'>152</span>          * @event
<span class='line'>153</span>          * @description Called in the context of a user who has just been
<span class='line'>154</span>          * added to the group.
<span class='line'>155</span> 
<span class='line'>156</span>          * @example everyone.on('join', function () {
<span class='line'>157</span>          *   otherGroup.addUser(this.user.clientId);
<span class='line'>158</span>          * });
<span class='line'>159</span>          */</span><span class="WHIT">
<span class='line'>160</span> </span><span class="WHIT">        </span><span class="NAME">self.emit.call</span><span class="PUNC">(</span><span class="NAME">user</span><span class="PUNC">,</span><span class="WHIT"> </span><span class="STRN">'join'</span><span class="PUNC">)</span><span class="PUNC">;</span><span class="WHIT">
...
<span class='line'>166</span>    * @name removeUser
<span class='line'>167</span>    * @function
<span class='line'>168</span>    * @memberOf Group#
<span class='line'>169</span>    * @version 0.7.0
<span class='line'>170</span>    * @description Removes the user identified by clientId from this group.
<span class='line'>171</span> 
<span class='line'>172</span>    * @param {String} clientId The client ID associated with the target
<span class='line'>173</span>    * user.
<span class='line'>174</span> 
<span class='line'>175</span>    * @example otherGroup.removeUser('1234567890');
<span class='line'>176</span>    */</span><span class="WHIT">
<span class='line'>177</span> </span><span class="WHIT">  </span><span class="NAME">Group.prototype.removeUser</span><span class="WHIT"> </span><span class="PUNC">=</span><span class="WHIT"> </span><span class="KEYW">function</span><span class="WHIT"> </span><span class="PUNC">(</span><span class="NAME">clientId</span><span class="PUNC">)</span><span class="WHIT"> </span><span class="PUNC">{</span><span class="WHIT">
<span class='line'>178</span> </span><span class="WHIT">    </span><span class="KEYW">var</span><span class="WHIT"> </span><span class="NAME">self</span><span class="WHIT"> </span><span class="PUNC">=</span><span class="WHIT"> </span><span class="KEYW">this</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>179</span> </span><span class="WHIT">    </span><span class="NAME">this.hasClient</span><span class="PUNC">(</span><span class="NAME">clientId</span><span class="PUNC">,</span><span class="WHIT"> </span><span class="KEYW">function</span><span class="WHIT"> </span><span class="PUNC">(</span><span class="NAME">hasClient</span><span class="PUNC">)</span><span class="WHIT"> </span><span class="PUNC">{</span><span class="WHIT">
<span class='line'>180</span> </span><span class="WHIT">      </span><span class="KEYW">if</span><span class="WHIT"> </span><span class="PUNC">(</span><span class="PUNC">!</span><span class="NAME">hasClient</span><span class="PUNC">)</span><span class="WHIT"> </span><span class="PUNC">{</span><span class="WHIT">
<span class='line'>181</span> </span><span class="WHIT">        </span><span class="KEYW">return</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>182</span> </span><span class="WHIT">      </span><span class="PUNC">}</span><span class="WHIT">
<span class='line'>183</span> </span><span class="WHIT">      </span><span class="KEYW">var</span><span class="WHIT"> </span><span class="NAME">user</span><span class="WHIT"> </span><span class="PUNC">=</span><span class="WHIT"> </span><span class="NAME">nowUtil.clone</span><span class="PUNC">(</span><span class="NAME">self.users</span><span class="PUNC">[</span><span class="NAME">clientId</span><span class="PUNC">]</span><span class="PUNC">,</span><span class="WHIT"> </span><span class="PUNC">{</span><span class="STRN">'_events'</span><span class="PUNC">:</span><span class="WHIT"> </span><span class="NAME">self._events</span><span class="PUNC">}</span><span class="PUNC">)</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>184</span> 
<span class='line'>185</span> </span><span class="WHIT">      </span><span class="COMM">/**
<span class='line'>186</span>        * @name Group#leave
<span class='line'>187</span>        * @event
<span class='line'>188</span>        * @version 0.7.0
<span class='line'>189</span>        * @description Called in the context of a user who has just been
<span class='line'>190</span>        * removed from the group.
<span class='line'>191</span> 
<span class='line'>192</span>        * @example otherGroup.on('leave', function () {
<span class='line'>193</span>        *   // Store the context, i.e. the user who has just left.
<span class='line'>194</span>        *   var self = this;
<span class='line'>195</span>        *   // Check that the user is still connected to the server.
<span class='line'>196</span>        *   everyone.hasClient(this.user.clientId, function (bool) {
<span class='line'>197</span>        *     if (bool) {
<span class='line'>198</span>        *       // Send parting words to the client.
<span class='line'>199</span>        *       this.now.receive('SERVER', 'Goodbye. I'll miss you dearly.');
<span class='line'>200</span>        *     }
<span class='line'>201</span>        *   });
<span class='line'>202</span>        * });
<span class='line'>203</span>        */</span><span class="WHIT">
<span class='line'>204</span> </span><span class="WHIT">      </span><span class="NAME">self.emit.call</span><span class="PUNC">(</span><span class="NAME">user</span><span class="PUNC">,</span><span class="WHIT"> </span><span class="STRN">'leave'</span><span class="PUNC">)</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>205</span> </span><span class="WHIT">      </span><span class="COMM">// Delete all remote functions that are part of this group from</span><span class="WHIT">
<span class='line'>206</span> </span><span class="WHIT">      </span><span class="COMM">// the user.</span><span class="WHIT">
<span class='line'>207</span> </span><span class="WHIT">      </span><span class="KEYW">var</span><span class="WHIT"> </span><span class="NAME">fqns</span><span class="WHIT"> </span><span class="PUNC">=</span><span class="WHIT"> </span><span class="NAME">Object.keys</span><span class="PUNC">(</span><span class="NAME">self.scopeTable.data</span><span class="PUNC">)</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>208</span> </span><span class="WHIT">      </span><span class="KEYW">for</span><span class="WHIT"> </span><span class="PUNC">(</span><span class="KEYW">var</span><span class="WHIT"> </span><span class="NAME">i</span><span class="WHIT"> </span><span class="PUNC">=</span><span class="WHIT"> </span><span class="NUMB">0</span><span class="PUNC">;</span><span class="WHIT"> </span><span class="NAME">i</span><span class="WHIT"> </span><span class="PUNC">&lt;</span><span class="WHIT"> </span><span class="NAME">fqns.length</span><span class="PUNC">;</span><span class="WHIT"> </span><span class="NAME">i</span><span class="PUNC">++</span><span class="PUNC">)</span><span class="WHIT"> </span><span class="PUNC">{</span><span class="WHIT">
<span class='line'>209</span> </span><span class="WHIT">        </span><span class="KEYW">if</span><span class="WHIT"> </span><span class="PUNC">(</span><span class="KEYW">typeof</span><span class="WHIT"> </span><span class="NAME">self.scopeTable.data</span><span class="PUNC">[</span><span class="NAME">fqns</span><span class="PUNC">[</span><span class="NAME">i</span><span class="PUNC">]</span><span class="PUNC">]</span><span class="WHIT"> </span><span class="PUNC">===</span><span class="WHIT"> </span><span class="STRN">'function'</span><span class="WHIT"> </span><span class="PUNC">&&</span><span class="WHIT">
<span class='line'>210</span> </span><span class="WHIT">            </span><span class="NAME">self.scopeTable.data</span><span class="PUNC">[</span><span class="NAME">fqns</span><span class="PUNC">[</span><span class="NAME">i</span><span class="PUNC">]</span><span class="PUNC">]</span><span class="WHIT"> </span><span class="PUNC">!==</span><span class="WHIT"> </span><span class="NAME">nowUtil.noop</span><span class="WHIT"> </span><span class="PUNC">&&</span><span class="WHIT">
<span class='line'>211</span> </span><span class="WHIT">            </span><span class="NAME">user.scopeTable.data</span><span class="PUNC">[</span><span class="NAME">fqns</span><span class="PUNC">[</span><span class="NAME">i</span><span class="PUNC">]</span><span class="PUNC">]</span><span class="WHIT"> </span><span class="PUNC">===</span><span class="WHIT"> </span><span class="NAME">undefined</span><span class="PUNC">)</span><span class="WHIT"> </span><span class="PUNC">{</span><span class="WHIT">
<span class='line'>212</span> </span><span class="WHIT">          </span><span class="COMM">// Tell the user to delete his function.</span><span class="WHIT">
<span class='line'>213</span> </span><span class="WHIT">          </span><span class="NAME">user.deleteVar</span><span class="PUNC">(</span><span class="NAME">fqns</span><span class="PUNC">[</span><span class="NAME">i</span><span class="PUNC">]</span><span class="PUNC">)</span><span class="PUNC">;</span><span class="WHIT">
...
<span class='line'>216</span> </span><span class="WHIT">      </span><span class="KEYW">delete</span><span class="WHIT"> </span><span class="NAME">self.users</span><span class="PUNC">[</span><span class="NAME">clientId</span><span class="PUNC">]</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>217</span> </span><span class="WHIT">      </span><span class="KEYW">delete</span><span class="WHIT"> </span><span class="NAME">user.groups</span><span class="PUNC">[</span><span class="NAME">self.groupName</span><span class="PUNC">]</span><span class="PUNC">;</span><span class="WHIT">
...
<span class='line'>222</span>    * @memberOf Group#
<span class='line'>223</span>    * @function
<span class='line'>224</span>    * @name exclude
<span class='line'>225</span>    * @version 0.7.0
<span class='line'>226</span> 
<span class='line'>227</span>    * @description Returns a new Group that is identical to the calling
<span class='line'>228</span>    * group, except with the specified clients excluded. The returned
<span class='line'>229</span>    * group automatically updates to accommodate any changes made to
<span class='line'>230</span>    * its parent group.
<span class='line'>231</span> 
<span class='line'>232</span>    * @param {Array} clientIds A list of client IDs corresponding to
<span class='line'>233</span>    * clients to exclude.
<span class='line'>234</span> 
<span class='line'>235</span>    * @example everyone.now.distribute = function (msg) {
<span class='line'>236</span>    *   everyone.exclude([this.user.clientId]).now.receive(this.now.name, msg);
<span class='line'>237</span>    * };
<span class='line'>238</span>    * @example factionOne.now.distribute = function (msg) {
<span class='line'>239</span>    *   factionTwo.getUsers(function (users) {
<span class='line'>240</span>    *     factionOne.exclude(users).now.receive(this.user.clientId, msg);
<span class='line'>241</span>    *   });
<span class='line'>242</span>    * };
<span class='line'>243</span> 
<span class='line'>244</span>    * @type Group
<span class='line'>245</span>    */</span><span class="WHIT">
<span class='line'>246</span> </span><span class="WHIT">  </span><span class="NAME">Group.prototype.exclude</span><span class="WHIT"> </span><span class="PUNC">=</span><span class="WHIT"> </span><span class="KEYW">function</span><span class="WHIT"> </span><span class="PUNC">(</span><span class="NAME">clientIds</span><span class="PUNC">)</span><span class="WHIT"> </span><span class="PUNC">{</span><span class="WHIT">
<span class='line'>247</span> </span><span class="WHIT">    </span><span class="KEYW">var</span><span class="WHIT"> </span><span class="NAME">excludes</span><span class="WHIT"> </span><span class="PUNC">=</span><span class="WHIT"> </span><span class="PUNC">{</span><span class="PUNC">}</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>248</span> </span><span class="WHIT">    </span><span class="KEYW">if</span><span class="PUNC">(</span><span class="KEYW">typeof</span><span class="WHIT"> </span><span class="NAME">clientIds</span><span class="WHIT"> </span><span class="PUNC">===</span><span class="WHIT"> </span><span class="STRN">'string'</span><span class="PUNC">)</span><span class="WHIT"> </span><span class="PUNC">{</span><span class="WHIT">
<span class='line'>249</span> </span><span class="WHIT">      </span><span class="KEYW">return</span><span class="WHIT"> </span><span class="NAME">this.exclude</span><span class="PUNC">(</span><span class="PUNC">[</span><span class="NAME">clientIds</span><span class="PUNC">]</span><span class="PUNC">)</span><span class="PUNC">;</span><span class="WHIT">
...
<span class='line'>251</span> </span><span class="WHIT">      </span><span class="KEYW">for</span><span class="WHIT"> </span><span class="PUNC">(</span><span class="KEYW">var</span><span class="WHIT"> </span><span class="NAME">i</span><span class="WHIT"> </span><span class="PUNC">=</span><span class="WHIT"> </span><span class="NUMB">0</span><span class="PUNC">;</span><span class="WHIT"> </span><span class="NAME">i</span><span class="WHIT"> </span><span class="PUNC">&lt;</span><span class="WHIT"> </span><span class="NAME">clientIds.length</span><span class="PUNC">;</span><span class="WHIT"> </span><span class="NAME">i</span><span class="PUNC">++</span><span class="PUNC">)</span><span class="WHIT"> </span><span class="PUNC">{</span><span class="WHIT">
<span class='line'>252</span> </span><span class="WHIT">        </span><span class="NAME">excludes</span><span class="PUNC">[</span><span class="NAME">clientIds</span><span class="PUNC">[</span><span class="NAME">i</span><span class="PUNC">]</span><span class="PUNC">]</span><span class="WHIT"> </span><span class="PUNC">=</span><span class="WHIT"> </span><span class="KEYW">true</span><span class="PUNC">;</span><span class="WHIT">
...
<span class='line'>255</span> </span><span class="WHIT">    </span><span class="KEYW">var</span><span class="WHIT"> </span><span class="NAME">group</span><span class="WHIT"> </span><span class="PUNC">=</span><span class="WHIT"> </span><span class="NAME">nowUtil.clone</span><span class="PUNC">(</span><span class="KEYW">this</span><span class="PUNC">,</span><span class="WHIT"> </span><span class="PUNC">{</span><span class="NAME">excludes</span><span class="PUNC">:</span><span class="WHIT"> </span><span class="NAME">nowUtil.clone</span><span class="PUNC">(</span><span class="NAME">this.excludes</span><span class="PUNC">,</span><span class="WHIT"> </span><span class="NAME">excludes</span><span class="PUNC">)</span><span class="PUNC">}</span><span class="PUNC">)</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>256</span> </span><span class="WHIT">    </span><span class="NAME">group.now</span><span class="WHIT"> </span><span class="PUNC">=</span><span class="WHIT"> </span><span class="NAME">Proxy.wrap</span><span class="PUNC">(</span><span class="NAME">group</span><span class="PUNC">)</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>257</span> </span><span class="WHIT">    </span><span class="KEYW">return</span><span class="WHIT"> </span><span class="NAME">group</span><span class="PUNC">;</span><span class="WHIT">
...
<span class='line'>261</span>    * @memberOf Group#
<span class='line'>262</span>    * @function
<span class='line'>263</span>    * @name hasClient
<span class='line'>264</span> 
<span class='line'>265</span>    * @description Used to determine a given user's membership in the
<span class='line'>266</span> <span class='line'>267</span>    * group.
<span class='line'>268</span> 
<span class='line'>269</span>    * @param {String} clientId The client ID associated with the target
<span class='line'>270</span>    * user.
<span class='line'>271</span> 
<span class='line'>272</span>    * @param {Function} callback Called with a Boolean indicating the
<span class='line'>273</span>    * user's membership in the group.
<span class='line'>274</span> 
<span class='line'>275</span>    * @example group.hasClient('1234567890', function (bool) {
<span class='line'>276</span>    *   if (bool) {
<span class='line'>277</span>    *     console.log('User is a member of `group`.');
...
<span class='line'>282</span> </span><span class="WHIT">    </span><span class="NAME">callback</span><span class="PUNC">(</span><span class="NAME">this.users</span><span class="PUNC">[</span><span class="NAME">clientId</span><span class="PUNC">]</span><span class="WHIT"> </span><span class="PUNC">!==</span><span class="WHIT"> </span><span class="NAME">undefined</span><span class="PUNC">)</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>283</span> <span class='line'>284</span> </span><span class="WHIT">  </span><span class="PUNC">}</span><span class="PUNC">;</span><span class="WHIT">
...
<span class='line'>289</span> </span><span class="WHIT">  </span><span class="NAME">Group.prototype.get</span><span class="WHIT"> </span><span class="PUNC">=</span><span class="WHIT"> </span><span class="KEYW">function</span><span class="WHIT"> </span><span class="PUNC">(</span><span class="NAME">fqn</span><span class="PUNC">)</span><span class="WHIT"> </span><span class="PUNC">{</span><span class="WHIT">
<span class='line'>290</span> </span><span class="WHIT">    </span><span class="KEYW">var</span><span class="WHIT"> </span><span class="NAME">value</span><span class="WHIT"> </span><span class="PUNC">=</span><span class="WHIT"> </span><span class="NAME">this.scopeTable.get</span><span class="PUNC">(</span><span class="NAME">fqn</span><span class="PUNC">)</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>291</span> </span><span class="WHIT">    </span><span class="COMM">// If this is a regular group, look in `everyone` for the value</span><span class="WHIT">
<span class='line'>292</span> </span><span class="WHIT">    </span><span class="KEYW">if</span><span class="WHIT"> </span><span class="PUNC">(</span><span class="NAME">value</span><span class="WHIT"> </span><span class="PUNC">===</span><span class="WHIT"> </span><span class="NAME">undefined</span><span class="WHIT"> </span><span class="PUNC">&&</span><span class="WHIT"> </span><span class="PUNC">!</span><span class="NAME">this.isSuperGroup</span><span class="PUNC">)</span><span class="WHIT"> </span><span class="PUNC">{</span><span class="WHIT">
<span class='line'>293</span> </span><span class="WHIT">      </span><span class="NAME">value</span><span class="WHIT"> </span><span class="PUNC">=</span><span class="WHIT"> </span><span class="NAME">nowjs.getGroup</span><span class="PUNC">(</span><span class="STRN">'everyone'</span><span class="PUNC">)</span><span class="PUNC">.</span><span class="NAME">scopeTable.get</span><span class="PUNC">(</span><span class="NAME">fqn</span><span class="PUNC">)</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>294</span> </span><span class="WHIT">    </span><span class="PUNC">}</span><span class="WHIT">
<span class='line'>295</span> 
<span class='line'>296</span> </span><span class="WHIT">    </span><span class="COMM">// If this is a function, return a multicaller.</span><span class="WHIT">
<span class='line'>297</span> </span><span class="WHIT">    </span><span class="KEYW">if</span><span class="WHIT"> </span><span class="PUNC">(</span><span class="KEYW">typeof</span><span class="WHIT"> </span><span class="NAME">value</span><span class="WHIT"> </span><span class="PUNC">===</span><span class="WHIT"> </span><span class="STRN">'function'</span><span class="PUNC">)</span><span class="WHIT"> </span><span class="PUNC">{</span><span class="WHIT">
<span class='line'>298</span> </span><span class="WHIT">      </span><span class="KEYW">var</span><span class="WHIT"> </span><span class="NAME">group</span><span class="WHIT"> </span><span class="PUNC">=</span><span class="WHIT"> </span><span class="NAME">nowUtil.clone</span><span class="PUNC">(</span><span class="KEYW">this</span><span class="PUNC">,</span><span class="WHIT"> </span><span class="PUNC">{</span><span class="NAME">fqn</span><span class="PUNC">:</span><span class="WHIT"> </span><span class="NAME">fqn</span><span class="PUNC">}</span><span class="PUNC">)</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>299</span> </span><span class="WHIT">      </span><span class="NAME">value</span><span class="WHIT"> </span><span class="PUNC">=</span><span class="WHIT"> </span><span class="NAME">fn.multicall.bind</span><span class="PUNC">(</span><span class="NAME">group</span><span class="PUNC">)</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>300</span> </span><span class="WHIT">    </span><span class="PUNC">}</span><span class="WHIT">
<span class='line'>301</span> </span><span class="WHIT">    </span><span class="KEYW">return</span><span class="WHIT"> </span><span class="NAME">value</span><span class="PUNC">;</span><span class="WHIT">
...
<span class='line'>320</span> </span><span class="WHIT">  </span><span class="KEYW">return</span><span class="WHIT"> </span><span class="NAME">Group</span><span class="PUNC">;</span><span class="WHIT">
...
<span class='line'>324</span>  * @name Group#connect
<span class='line'>325</span>  * @event
<span class='line'>326</span>  * @deprecated As of 0.7.0. Use nowjs#connect instead.
<span class='line'>327</span>  * @description Called in the context of a user when the server
<span class='line'>328</span>  * first receives a message from the given user.
<span class='line'>329</span>  */</span><span class="WHIT">
<span class='line'>330</span> 
<span class='line'>331</span> </span><span class="COMM">/**
<span class='line'>332</span>  * @name Group#disconnect
<span class='line'>333</span>  * @event
<span class='line'>334</span>  * @deprecated As of 0.7.0. Use nowjs#disconnect instead.
<span class='line'>335</span>  * @description Called in the context of a user who has just
<span class='line'>336</span>  * disconnected from the server.
